...
namespace AJCHospitalConsol.Logic
{
    internal class LogicTest
    {
        ...
        static void TestHospitalManagement()
        {
            ...
            Hospital Hospital = new Hospital("Hôpital XYZ");

            // Création de patients
            Patient patient1 = new Patient(1255, "316HH", "toto", "titi", 54445, 21,"3rue du Gral de Gaulle");
            Patient patient2 = new Patient(1255, "316HH", "coco", "cici", 54466675, 12, "7 rue du Mrchal lecler");
